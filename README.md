...
<a href="https://github.com/mdsahilhussain/disney-plus-clone/blob/main/package.json" target="_blank">🔶 Dependency Info</a>
...
```bash
  git clone https://github.com/mdsahilhussain/disney-plus-clone.git
```
